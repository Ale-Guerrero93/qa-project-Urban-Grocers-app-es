...
def test_create_user_512_letter_in_kit_name_get_error_response():
    auth_token = create_new_user_token_on_success()
    negative_assert(data.kit_body_name_exceeds_limit, auth_token)

def test_create_user_english_letter_in_kit_name_get_success_response():
    auth_token = create_new_user_token_on_success()
    positive_assert({"name": " A Aaa "}, auth_token)


def test_create_user_has_special_symbol_in_kit_name_get_success_response():
    auth_token = create_new_user_token_on_success()
